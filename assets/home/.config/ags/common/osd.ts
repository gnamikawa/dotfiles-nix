...
//
// Content is read once, at the moment of the triggering keypress, by the
// Hyprland Lua bind itself (see hosts/GEN-LPC/hyprland-outputs.nix and
// hypr/binds.lua) and passed as an `ags request` argument — not re-derived
